...
# Setup Padding for Every Batch (all examples should be of same seq_len)
...
class FlickrDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img = Image.open(os.path.join(self.root_dir, img_d)).convert("RGB")
        if self.transform:
...
# For Padding we make this class
class MyCollate:
